	...
	for epoch in range(TRAIN_EPOCHS):
		...
		for step in tqdm(range(TRAIN_STEPS)):
			...
			with tf.GradientTape() as tape:
				...
				min_cut_observation = (image_observation_raw - tf.math.reduce_min(image_observation_raw))

				image_observation = (min_cut_observation * 2. / tf.math.reduce_max(min_cut_observation)) - 1.
